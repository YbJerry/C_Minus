...
static const flex_int16_t yy_accept[59] =
    {   0,
        0,    0,   35,   33,   31,   30,   30,   32,   33,   22,
       23,   11,    9,   21,   10,   12,    8,   20,   13,   19,
       15,    7,   24,   25,    7,    7,    7,    7,    7,   26,
       27,   29,   18,   28,    8,   14,   17,   16,    7,    7,
        1,    7,    7,    7,    7,    7,    3,    7,    7,    7,
        2,    7,    5,    7,    7,    6,    4,    0
    } ;
...
static const flex_int16_t yy_base[60] =
    {   0,
        0,    0,   65,   66,   66,   66,   61,   66,   46,   66,
       66,   66,   66,   66,   66,   53,   47,   66,   43,   42,
       41,    0,   66,   66,   30,   14,   33,   26,   29,   66,
       66,   66,   66,   66,   39,   66,   66,   66,    0,   21,
        0,   19,   18,   23,   22,   24,    0,   13,   23,   17,
        0,   13,    0,   18,   12,    0,    0,   66,   37
    } ;
...
static const flex_int16_t yy_nxt[104] =
    {   0,
       ...
       22,   22,   22,   28,   29,   30,   31,   41,   39,   57,
       56,   42,   55,   54,   53,   52,   51,   50,   49,   48,
       47,   46,   35,   45,   44,   43,   40,   38,   37,   36,
       35,   34,   33,   32,   58,    3,   58,   58,   58,   58,
       58,   58,   58,   58,   58,   58,   58,   58,   58,   58,
       58,   58,   58,   58,   58,   58,   58,   58,   58,   58,
       58,   58,   58,   58,   58,   58,   58,   58,   58,   58,
...
static const flex_int16_t yy_chk[104] =
    {   0,
       ...
       54,   26,   52,   50,   49,   48,   46,   45,   44,   43,
       42,   40,   35,   29,   28,   27,   25,   21,   20,   19,
       17,   16,    9,    7,    3,   58,   58,   58,   58,   58,
       58,   58,   58,   58,   58,   58,   58,   58,   58,   58,
       58,   58,   58,   58,   58,   58,   58,   58,   58,   58,
       58,   58,   58,   58,   58,   58,   58,   58,   58,   58,
...
YY_RULE_SETUP
#line 30 "C_Minus.l"
{charNo += strlen(yytext); return IF;}
	YY_BREAK
case 2:
YY_RULE_SETUP
#line 31 "C_Minus.l"
{charNo += strlen(yytext); return ELSE;}
	YY_BREAK
case 3:
YY_RULE_SETUP
#line 32 "C_Minus.l"
{charNo += strlen(yytext); return INT;}
	YY_BREAK
case 4:
YY_RULE_SETUP
#line 33 "C_Minus.l"
{charNo += strlen(yytext); return RETURN;}
	YY_BREAK
case 5:
YY_RULE_SETUP
#line 34 "C_Minus.l"
{charNo += strlen(yytext); return VOID;}
	YY_BREAK
case 6:
YY_RULE_SETUP
#line 35 "C_Minus.l"
{charNo += strlen(yytext); return WHILE;}
	YY_BREAK
case 7:
YY_RULE_SETUP
#line 37 "C_Minus.l"
